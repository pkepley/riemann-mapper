...
ax.plot(xs_b, ys_b)
ax.scatter(ws_xx, ws_yy, c=ws_xx, marker=".", cmap="plasma")
ax.set_axis_off()
ax.set_aspect("equal")
...
ax.plot(circ_xs, circ_ys, label="circle")
ax.scatter(x_zz, y_zz, c=ws_xx, marker=".", cmap="plasma")
ax.axis([-1, 1, -1, 1])
ax.set_axis_off()
ax.set_aspect("equal")
...
if save_image_flag:
    plt.figure(1)
    plt.savefig("../imgs/indianaSource.png", bbox_inches="tight", pad_inches=0)
    plt.figure(2)
    plt.savefig("../imgs/indianaTarget.png", bbox_inches="tight", pad_inches=0)
